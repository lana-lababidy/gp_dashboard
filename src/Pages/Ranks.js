...
// const DONATIONS_BY_TYPE = [
//   { name: "Material", value: 420 },
//   { name: "In-kind", value: 280 },
//   { name: "Volunteer", value: 200 },
// ];

// const SCHOOLS_TOP = [
//   { name: "Al-Rabee Primary", value: 92, amount: 35000 },
//   { name: "Al-Noor Secondary", value: 70, amount: 22000 },
//   { name: "Al-Mustaqbal Model", value: 55, amount: 18000 },
//   { name: "Al-Rayan Private", value: 40, amount: 12000 },
//   { name: "Success School", value: 30, amount: 8000 },
// ];

// const TOP_DONORS = [
//   { name: "Ahmad Khalil", donations: 24, favorite: "Material" },
//   { name: "Sarah Yusuf", donations: 18, favorite: "In-kind" },
//   { name: "Mohammad Ali", donations: 15, favorite: "Volunteer" },
//   { name: "Layla Khaled", donations: 11, favorite: "Material" },
//   { name: "Rami Adnan", donations: 9, favorite: "In-kind" },
// ];
...
//       <h1 className="text-xl font-bold mb-4">Rank & Categories</h1>

//       {/* Top Summary Cards */}
//       <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
//         <div className="bg-white p-5 rounded-xl shadow">
//           <h4 className="text-sm text-gray-500">Top donor this month</h4>
//           <p className="text-lg font-semibold">Sarah Yusuf</p>
//           <p className="text-2xl font-bold">$15,000</p>
//         </div>
//         <div className="bg-white p-5 rounded-xl shadow">
//           <h4 className="text-sm text-gray-500">Top school</h4>
//           <p className="text-lg font-semibold">Al-Rabee Primary</p>
//           <p className="text-2xl font-bold">92</p>
//         </div>
//         <div className="bg-white p-5 rounded-xl shadow">
//           <h4 className="text-sm text-gray-500">Most common type</h4>
...
//         <div className="bg-white p-5 rounded-xl shadow">
//           <h4 className="text-sm text-gray-500 mb-4">Donations by category</h4>
//           <div className="h-64">
...
//         </div>
//         <div className="bg-white p-5 rounded-xl shadow">
//           <h4 className="text-sm text-gray-500 mb-4">Top schools ranking</h4>
//           <div className="h-64">
//             <ResponsiveContainer width="100%" height="100%">
//               <BarChart data={SCHOOLS_TOP}>
//                 <XAxis dataKey="name" />
//                 <YAxis />
//                 <Tooltip />
...
//       <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
//         <div className="bg-white p-5 rounded-xl shadow">
//           <h4 className="text-sm text-gray-500 mb-4">Top 10 donors</h4>
//           <table className="min-w-full text-sm">
//             <thead>
//               <tr className="text-left text-gray-500 border-b">
//                 <th className="py-2">Donor</th>
//                 <th className="py-2">Donations</th>
//                 <th className="py-2">Favorite</th>
//               </tr>
//             </thead>
//             <tbody>
//               {TOP_DONORS.map((d) => (
...
//                   <td className="py-2">{d.donations}</td>
//                   <td className="py-2">{d.favorite}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
...
//         <div className="bg-white p-5 rounded-xl shadow">
//           <h4 className="text-sm text-gray-500 mb-4">Top 10 schools</h4>
//           <table className="min-w-full text-sm">
//             <thead>
//               <tr className="text-left text-gray-500 border-b">
...
//                   <td className="py-2">${s.amount.toLocaleString()}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
